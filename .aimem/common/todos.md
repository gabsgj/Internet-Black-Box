# Common Development To-Dos

Master tracking sheet of major project milestones and tasks.

- [ ] Define shared Neo4j schema entity model classes in Spring Boot <!-- id: 0 -->
- [ ] Connect Spring Boot project to local and cloud Neo4j instances <!-- id: 1 -->
- [ ] Implement GitHub commit and PR webhook handlers on backend <!-- id: 2 -->
- [ ] Implement Slack event verification and message consumer on backend <!-- id: 3 -->
- [ ] Implement Sentry alert ingestion webhook on backend <!-- id: 4 -->
- [ ] Construct Claude reconstruction prompt template and integration <!-- id: 5 -->
- [ ] Implement Neo4j causal shortest path finder Cypher query <!-- id: 6 -->
